...
AnimalChat es una aplicación web inspirada en WhatsApp. La aplicación permite simular conversaciones entre usuarios, visualizar perfiles con descripción y galería, cambiar el fondo del chat y ver los distintos contactos.

Funciones principales:
- Login de usuario
- Lista de chats
- Envío y visualización de mensajes
- Autoscroll automático al último mensaje
- Perfil del contacto con:
  - Avatar
  - Teléfono
  - Email
  - Descripción
